# IG MCP Server – SCaLE Materials

This repository houses all the materials needed for the SCaLE (Southern California Linux Expo) presentation on the **Inspektor Gadget MCP Server**.
